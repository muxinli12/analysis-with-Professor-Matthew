...
```
27.68% people have a history of wheezing or whistling and have relapsed within 12 months
...
### if exercise-induced has relationship with wheeze history
```{r}
exercise=
  analysis1_6_7|>
  filter(exwhez12==1)
...
```
86.62% exercise-induced have a history of wheezing or whistling and have relapsed within 12 months
